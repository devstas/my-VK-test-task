...
//  VKtest
//
//  Created by Станислав Серов on 28.05.18.
...
class VkAPI {
    ...
    private let urlVkAuthorization = "https://oauth.vk.com/authorize"
    private let paramAuthorization = [
        "client_id"     : "6489122",
    ...
    // MARK: - API methods
    func getUrlForAuthorization() -> URL {
        return getUrlRequest(url: urlVkAuthorization, parameters: paramAuthorization)
    }
